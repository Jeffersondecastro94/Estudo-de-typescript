# Exercicios Basicos de typescript 
  
*QUAL A MOTIVAÇÃO?*

o Intuito é a pratica do uso do typescript , dessa forma temos alguns desafios e suas respostas. 
ou seja, os desafios são alguns codigos em javascript e suas respostas são esses codigos recebendo o typescript ou varias possibilidades de usar o typescript para tipar o código esse código JS.
...
* *desafios*
    * Contém vários arquivos JS que podem ser refatorados para solidificar o conhecimento adquirido
* *index.html*
    * É onde está a chamada para o arquivo app.js e pode ser manipulado a vontade para testarem os scripts
* *tsconfig.json*
